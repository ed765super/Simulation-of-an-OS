...
fileNode::fileNode(unsigned int pData[NODESIZE]){
...
void fileNode::getName(unsigned int dummyName[5]){
  ...
  //associated with this file node has been placed in name1
  name2 = data[1];
  name3 = data[2];
  name4 = data[3];
  name5 = data[4];
...
//PRE: this object is defined
//POST: RV =  this object's file size
unsigned int fileNode::getFileSize() const{
  return data[5];
}

//PRE: this object is defined
//POST: RV =  this object's parent
unsigned int fileNode::getParent() const{
...
unsigned int fileNode::getFirstContent() const{
...
unsigned int fileNode::getPrevSibling() const{
...
//PRE: this object is defined
//POST: RV =  this object's previous siblings
unsigned int fileNode::getNextSibling() const{
...
void fileNode::setName(unsigned int pName[5]){
  int dataByte0 = 0; //represents the byte number 0 of some word of
		     //data
  int dataByte1 = 1; //represents the byte number 1 of some word of
		     //data
...
//POST: modifies the data member object associated with this
//function s.t. it is equal to the parameter
void fileNode::setFileSize(unsigned int pFileSize){
  data[5] = pFileSize;
}
...
//POST: modifies the data member object associated with this
//function s.t. it is equal to the parameter
void fileNode::setParent (unsigned int pParent){
  int dataByte0 = 0; //represents the byte number 0 of some word of
		     //data
  int dataByte1 = 1; //represents the byte number 1 of some word of
		     //data
...
//POST: modifies the data member object associated with this
//function s.t. it is equal to the parameter
void fileNode::setFirstContent(unsigned int pChild){
  int dataByte2 = 2; //represents the byte number 2 of some word of
		     //data
  int dataByte3 = 3; //represents the byte number 3 of some word of
		     //data
...
//POST: modifies the data member object associated with this
//function s.t. it is equal to the parameter
void fileNode::setPrevSibling(unsigned int pPrevSibling){
  int dataByte0 = 0; //represents the byte number 0 of some word of
		     //data
  int dataByte1 = 1; //represents the byte number 1 of some word of
		     //data
...
//POST: modifies the data member object associated with this
//function s.t. it is equal to the parameter
void fileNode::setNextSibling(unsigned int pNextSibling){
  int dataByte2 = 2; //represents the byte number 2 of some word of
		     //data
  int dataByte3 = 3; //represents the byte number 3 of some word of
		     //data
...
ostream & operator << (ostream & stream, const fileNode & thisNode){
